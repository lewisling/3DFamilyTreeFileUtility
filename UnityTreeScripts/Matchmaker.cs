...
public class Matchmaker
{
	...
	public void addToSinglesList(int newPersonIndex, Person.PersonSex sex)
	{
	...
	public void removeFromSinglesList(int deadPersonIndex, Person.PersonSex sex)
	{
		if (sex == Person.PersonSex.Female)
	...
	public void beFruitfullAndMultiply(int currentYear)
	{
		...
		foreach(Family myFamily in allFamilies)
		{
			...
			{
				Person MyChild = new Person(Person.PersonType.Unique, currentYear.ToString());
